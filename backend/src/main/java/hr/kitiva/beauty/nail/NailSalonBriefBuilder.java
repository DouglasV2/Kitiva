...
public class NailSalonBriefBuilder {
    ...
    public SalonBrief build(NailDesignSpecDto design, List<hr.kitiva.beauty.dto.Assumption> assumptions) {
    ...
    private String copyText(List<SpecLine> spec, List<String> placement, String showToTech,
                            List<String> notes, List<hr.kitiva.beauty.dto.Assumption> assumptions,
                            String disclaimer) {
